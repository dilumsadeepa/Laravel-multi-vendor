        ...
        <div class="col-lg-5 pb-5">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                      <img class="d-block w-100" src="{{ asset('images/products/4.jpg') }}" alt="Third slide">
                    </div>
                  </div>
                ...
                <div class="thumbwrapper">
                    <ol class="carousel-indicators thumbspic">
                        ...
                        <img src="{{ asset('images/products/4.jpg') }}" alt="" srcset="" style="max-width:80px;" data-target="#carouselExampleIndicators" data-slide-to="2" class="mr-2">
                    </ol>
                </div>
